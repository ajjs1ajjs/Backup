...
- Розширений фронтенд UI
- Docker/Compose CI: запуск всіх сервісів (DB, API, UI) локально для тестів та CI
- Документація: гайд по міграції backups.json → DB для всіх діалектів та cloud провайдерів
- Міграція: Alembic миграційні скрипти та їх інтеграція
- Безпека та аудит: розширення аудиту запитів та моніторинг безпеки
- Релізи та релізний процес
