...
func (m *MockTenantManager) GetTenant(ctx context.Context, tenantID string) (*multitenancy.Tenant, error) {
	return &multitenancy.Tenant{ID: tenantID, Name: "Test Tenant"}, nil
}

func (m *MockTenantManager) ListTenants(ctx context.Context) ([]multitenancy.Tenant, error) {
	return []multitenancy.Tenant{{ID: "test-tenant", Name: "Test Tenant"}}, nil
}

// MockDeduplicationManager for testing
type MockDeduplicationManager struct{}

func (m *MockDeduplicationManager) CalculateHash(data []byte) string {
	return "test-hash"
}

func (m *MockDeduplicationManager) IsDuplicate(hash string) bool {
	return false
}

func (m *MockDeduplicationManager) StoreBlock(hash string, data []byte) error {
	return nil
}

func (m *MockDeduplicationManager) GetBlock(hash string) ([]byte, error) {
...
func TestBackupCopyManager(t *testing.T) {
	...
	t.Run("CreateJob", func(t *testing.T) {
		...
		manager := NewInMemoryBackupCopyManager(mockTenantMgr, mockDedupeMgr)
