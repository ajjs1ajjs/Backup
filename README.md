...
| **Stage 10** | Розширений UI та автоматизація | ✅ Завершено |
...
### 🎨 Нові можливості Stage 10

- **Розширений Dashboard**
  - Графіки на Chart.js (бекапи по днях, розподіл по провайдерах)
  - Статистичні картки з іконками
  - Адаптивна сітка

- **Темна тема**
  - Toggle світла/темна тема
  - Збереження вибору в localStorage
  - Плавні переходи кольорів

- **Нові сторінки**
  - `/settings` - Налаштування (сповіщення, експорт/імпорт)
  - `/users` - Управління користувачами (admin only)

- **Функціонал**
  - Експорт конфігурації в JSON
  - Імпорт конфігурації
  - Тестові сповіщення
  - Перегляд користувачів з ролями та scopes
