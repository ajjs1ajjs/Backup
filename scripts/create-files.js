...
const mainGoContent = `// NovaBackup Windows Service
...
const outputPath = path.join(__dirname, "..", "cmd", "nova-service", "main.go");
fs.writeFileSync(outputPath, mainGoContent, "utf8");
