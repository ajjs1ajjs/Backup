...
class GCPCloudProvider:
    ...
    def list_vms(self) -> List[Dict[str, Any]]:
        try:
            ...
            req = service.instances().aggregatedList(
                project=self.project_id, filter=None, maxResults=1000
            )
            resp = req.execute()
            vms = []
    ...
    def backup_to_cloud(
        ...
        try:
            ...
            # Real logic would go here; return mock result if credentials present
