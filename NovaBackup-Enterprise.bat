...
REM Create simple GUI using PowerShell
powershell -ExecutionPolicy Bypass -Command "Add-Type -AssemblyName System.Windows.Forms; Add-Type -AssemblyName System.Drawing; $form = New-Object System.Windows.Forms.Form; $form.Text = 'NovaBackup v6.0 Enterprise'; $form.Size = New-Object System.Drawing.Size(800, 600); $form.StartPosition = 'CenterScreen'; $form.BackColor = [System.Drawing.Color]::FromArgb(45, 45, 48); $label = New-Object System.Windows.Forms.Label; $label.Text = 'NovaBackup v6.0 Enterprise Backup & Recovery'; $label.Font = New-Object System.Drawing.Font('Arial', 16, [System.Drawing.FontStyle]::Bold); $label.ForeColor = [System.Drawing.Color]::White; $label.Location = New-Object System.Drawing.Point(50, 50); $label.Size = New-Object System.Drawing.Size(700, 50); $form.Controls.Add($label); $status = New-Object System.Windows.Forms.Label; $status.Text = 'Status: All Systems Operational'; $status.Font = New-Object System.Drawing.Font('Arial', 12); $status.ForeColor = [System.Drawing.Color]::LightGreen; $status.Location = New-Object System.Drawing.Point(50, 150); $status.Size = New-Object System.Drawing.Size(400, 30); $form.Controls.Add($status); $button = New-Object System.Windows.Forms.Button; $button.Text = 'OK'; $button.Location = New-Object System.Drawing.Point(350, 250); $button.Size = New-Object System.Drawing.Size(100, 30); $button.BackColor = [System.Drawing.Color]::FromArgb(0, 120, 215); $button.ForeColor = [System.Drawing.Color]::White; $form.Controls.Add($button); $button.Add_Click({$form.Close()}); $form.ShowDialog()"
goto menu
